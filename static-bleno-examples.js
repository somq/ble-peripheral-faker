...
bleno.on("stateChange", (state) => {
	...
	if (state === "poweredOn") {
		...
		var advertisementData = Buffer.from([3, 25, 0, 0, 2, 1, 5, 3, 3, 10, 24, 19, 9, 79, 67, 80, 67, 99, 54, 32, 35, 49, 57, 57, 57, 56, 56, 56, 48, 48, 48])
		var scanData = Buffer.from([30, 255, 255, 255, 26, 255, 65, 25, 0, 76, 0, 0, 67, 0, 0, 83, 0, 0, 87, 0, 0, 0, 0, 0, 0, 0, 84, 0, 0, 0, 0])
...
bleno.on("advertisingStart", (error) => {
	...
	bleno.setServices([
		new bleno.PrimaryService(service)
], (error) => {
